...
.main-page-container {
    ...
    .main-overlay {
        position: absolute;
        inset: 0;
        background: rgba(11, 8, 20, 0.7); // Darken the busy background
        z-index: 1;
        pointer-events: none;
    }
}
...
.app-header {
    height: 100px; // Increased height to accommodate logo + spacing
    display: flex;
    align-items: center;
    justify-content: space-between;
    padding: var(--space-4) var(--space-6) 0; // Add top padding
    z-index: 10;
    position: relative; 
